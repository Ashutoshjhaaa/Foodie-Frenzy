...
const About = () => {
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-[#1a120b] via-[#3c2a21] to-[#1a120b] text-amber-50 overflow-hidden relative'>
        ...
        <motion.section initial={{opacity: 0, y: 50}} animate={{opacity: 1, y: 0}} className='py-20 px-4 text-center relative '>
            <div className='max-w-4xl mx-auto'>
                <motion.h1 className='text-6xl sm:text-7xl md:text-8xl font-bold mb-6 font-serif bg-clip-text text-transparent bg-gradient-to-r from-amber-400 via-amber-200 to-amber-500'>
                    Culinary Express
                </motion.h1>
                <motion.p initial={{ opacity: 0}} animate={{ opacity: 1}} className='text-lg sm:text-xl md:text-2xl text-amber-100/90 font-light tracking-wide'>
            ...
            <div className='max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6'>
                {features.map((f, i) => {
                    ...
                    return (
                        ...
                        >
                            <div className='relative rounded-2xl overflow-hidden border border-amber-500/20 hover:border-amber-400 transition-all duration-500 shadow-xl'>
                                <div className='aspect-video overflow-hidden'>
                                    ...
                                    />
                                    <div className='absolute inset-0 bg-gradient-to-t from-[#1a120b] via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500' />
        ...
        <section className='py-16 px-4 md:px-8 bg-gradient-to-br from-[#1a120b] to-[#3c2a21]/90 '>
            <div className='max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8'>
                {stats.map((stat, i) => {
                    ...
                    return (
                        <motion.div key={stat.label} initial={{ opacity: 0, y:50}} transition={{ delay: i * 0.2, type: 'spring'}}
                            whileInView={{ opacity: 1, y: 0 }}
                            viewport={{ once: true }}
                            ...
                            <div className='relative h-full bg-[#3c2a21]/40 backdrop-blur-lg rounded-xl border-2 border-amber-600/30 p-6 overflow-hidden transition-all duration-300'> 
                                ...
                                <div className='relative z-10 h-full flex flex-col items-center justify-center'>
                                    ...
                                    <motion.div className='text-sm uppercase tracking-widest font-medium text-amber-100/80'
                                        animate={{ letterSpacing: hoveredStat === i ? '0.15em' : '0.1em', textShadow: hoveredStat === i ? '0 0 8px rgba(245, 158, 0, 0.4)' : 'none' }}>
                                        {stat.label}
                                    </motion.div>
                                </div>
                                <motion.div 
                            ...
                            <div className=' relative h-full bg-[#3c2a21]/90 backdrop-blur-lg rounded-3xl overflow-hidden
                                ...
                                hover:shadow-2xl hover:shadow-amber-500/20' >
                                    <div className='relative h-64 sm:h-72 md:h-96 overflow-hidden'>
                                        <motion.img src={m.img} alt={m.name} className='w-full h-full object-cover' initial={{scale:1}} whileHover={{sacle:1.1}} transition={{duration: 0.5}}/>
                                    ...
                                    <div className='p-8 text-center flex flex-col h-[calc(100%-24rem)]'>
                                        <div className='mb-4'>
                                            ...
                                            <p className='text-amber-500 text-lg font-medium italic font-serif'>
                                                {m.role}
                                            </p>
                                        </div>
