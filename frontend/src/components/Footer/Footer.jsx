        ...
        <div className='max-w-7xl mx-auto relative z-10 '>
            <div className='grid grid-cols-1 sm: grid-cols-2 md:grid-cols-3 gap-8 mb-12'>
                ...
                <div className=' space-y-6'>
                    ...
                    <p className='text-amber-200/90 text-sm font-sacramento italic'>
                     When culinary artistry meets doorstep convenience, Foodie-Frenzy delivers a symphony of flavors to your home. <br/> Savor the extraordinary, one bite at a time.

                    </p>
                    <form onSubmit={handleSubmit} className='relative mt-4 group'>
                        <div className='flex items-center gap-2 mb-2'>
                            <FaRegEnvelope className='text-amber-400animate-pulse'/>
                        ...
                        <div className='relative'>
                            ...
                            <span className='font-bold text-sm tracking-wide transition-transfrom duration-300 group-hover:translate-x-1'>
                                join Now


                            </span>
                            <BiChevronRight className='text-xl transition-transform duration-300 group-hover:animate-spin flex-shrink-0'/>
                            <span className='absolute inset-0 -translate-x-full bg-gradient-to-r from-transparent via-amber-50/30 to-transparent group-hover:translate-x-full transition-transfrom duration-700'/>
                ...
                <div className='flex justify-center'>
                    <div className='space-y-4'>
                        <h3 className='text-xl font-semibold mb-4 border-1-4 border-amber-400 pl-3 
                        ...
                        <ul className='space-y-3'>
                            {navItems.map(item => (
                                <li key={item.name}>
                                    <a href={item.link} className='flex-tem-center hover:text-amber-400 transition-all group font-lora hover:pl-2' >
                                        <BiChevronRight className='mr-2 text-amber-400 
            ...
            <div className='border-t border-amber-800 pt-8 mt-8 text-center'>
                ...
                <div className='group inline-block'>
                    <a 
                    // href="https://www.foodiefrenzy.com" target='_blank' 
